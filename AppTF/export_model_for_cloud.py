...
with tf.Session() as session:
    ...
    for epoch in range(training_epochs):
        ...
        if epoch % display_step == 0:
            ...
            print("Epoch:{}-Training cost:{}".format(epoch,training_cost,testing_cost))
    ...
    # now that neural network is trained,let's use it to make predictions
    ...
    predicted_earings = Y_predicted[0][0]

    print("the actual earnings of Game #1 were ${}".format(real_earnings))
    print("our neural network predicted earnings of ${}".format(predicted_earings))
